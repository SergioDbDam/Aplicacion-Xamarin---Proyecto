...
class Provincia_DBHelper {
    ...
    public function getAll() {
        $sql = "select id,nombre from registro order by id";
    ...
    public function get($id) {
        $sql = "select * from objetivos where registro_id=$id";
    ...
    function add($objetivo) {
        $sql = "insert into objetivos (objetivos,fecha,registro_id) "
                . "values ('{$objetivo->objetivos}','{$objetivo->fecha}','{$objetivo->registro_id}')";
