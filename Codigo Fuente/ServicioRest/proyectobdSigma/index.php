...
include __DIR__ . '/modelo/registros_DBHelper.php';
...
$app->get('/objetivos', function (Request $request, Response $response, array $args) use($db_prov) {
    $this["logger"]->debug('GET /objetivos');
...
$app->get('/objetivo/{id}', function (Request $request, Response $response, array $args) use($db_prov) {
    ...
    if ($objetivo) {
        ...
        return $response->withJson($db_prov->get(40));
